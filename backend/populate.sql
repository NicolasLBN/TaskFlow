...
VALUES (1, 'Task 1 for Optijet', 'Description for Task 1', 'todo', 1, 1, '2023-04-01T10:00:00Z', '2023-04-01T10:00:00Z');
INSERT INTO tasks (project_id, title, description, status, assigned_user_id, created_by, created_date, modified_date)
VALUES (1, 'Task 2 for Optijet', 'Description for Task 2', 'inProgress', 2, 1, '2023-04-02T11:00:00Z', '2023-04-02T11:00:00Z');
INSERT INTO tasks (project_id, title, description, status, assigned_user_id, created_by, created_date, modified_date)
VALUES (1, 'Task 3 for Optijet', 'Description for Task 3', 'done', 3, 1, '2023-04-03T12:00:00Z', '2023-04-03T12:00:00Z');
INSERT INTO tasks (project_id, title, description, status, assigned_user_id, created_by, created_date, modified_date)
VALUES (1, 'Task 4 for Optijet', 'Description for Task 4', 'todo', 2, 1, '2023-04-04T13:00:00Z', '2023-04-04T13:00:00Z');
INSERT INTO tasks (project_id, title, description, status, assigned_user_id, created_by, created_date, modified_date)
VALUES (1, 'Task 5 for Optijet', 'Description for Task 5', 'inProgress', 3, 1, '2023-04-05T14:00:00Z', '2023-04-05T14:00:00Z');

-- Ajouter des tâches pour le projet "mp100"
INSERT INTO tasks (project_id, title, description, status, assigned_user_id, created_by, created_date, modified_date)
VALUES (2, 'Task 1 for MP100', 'Description for Task 1', 'todo', 4, 4, '2023-04-01T10:00:00Z', '2023-04-01T10:00:00Z');
INSERT INTO tasks (project_id, title, description, status, assigned_user_id, created_by, created_date, modified_date)
VALUES (2, 'Task 2 for MP100', 'Description for Task 2', 'inProgress', 5, 4, '2023-04-02T11:00:00Z', '2023-04-02T11:00:00Z');
INSERT INTO tasks (project_id, title, description, status, assigned_user_id, created_by, created_date, modified_date)
VALUES (2, 'Task 3 for MP100', 'Description for Task 3', 'done', 4, 4, '2023-04-03T12:00:00Z', '2023-04-03T12:00:00Z');
INSERT INTO tasks (project_id, title, description, status, assigned_user_id, created_by, created_date, modified_date)
VALUES (2, 'Task 4 for MP100', 'Description for Task 4', 'todo', 5, 4, '2023-04-04T13:00:00Z', '2023-04-04T13:00:00Z');
INSERT INTO tasks (project_id, title, description, status, assigned_user_id, created_by, created_date, modified_date)
VALUES (2, 'Task 5 for MP100', 'Description for Task 5', 'inProgress', 4, 4, '2023-04-05T14:00:00Z', '2023-04-05T14:00:00Z');